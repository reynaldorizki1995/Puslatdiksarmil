        ...
        switch ($type) {
            case "article":
                ...
                case "edit_sejarah":
                    ...
                    header("Location: ../edit_sejarah.php", true, 301);
                    exit;
                    break;
            ...
            case "profil";
                ...
                uploadImage2("proImage", "../img/article/");

                // PREPARE DATA TO INSERT INTO DB
                $data = array(
                    "profil_title" => test_input($_POST["proTitle"]),
                    "profil_content" => $_POST["proContent"],
                    "profil_image" => test_input($_FILES["proImage"]["name"]),
                );
